...
var INTERVAL_RECORD_TABLE = 'IntervalRecord';
var BEACON_TABLE = 'Beacon';
...
var retrieveIntervalJSON = function (successCb, failureCb, args) {
  ...
  var retBusSuccess = function (business) {
    ...
    intervalQuery.ascending("timestamp");
...
// arguments must include the current parse user
// returns a list where each element is a beacon
var retrieveBeaconsJSON = function (successCb, failureCb, args) {
  var user = args['user'];

  // if business is successfully queried, then query beacon table
  var retBusSuccess = function (business) {
    var BeaconObj = Parse.Object.extend(BEACON_TABLE);
    var beaconQuery = new Parse.Query(BeaconObj);
    console.log(JSON.stringify(business));
...
exports.retrieveBeaconsJSON = retrieveBeaconsJSON;